...
`Recursive references between schemas, invalid tree`|The schema failed to load(`jsen: invalid schema reference node`). **This excludes this validator from performance tests**
...
`root ref in remote ref, null is valid`|The schema failed to load(`jsen: invalid schema reference name.json#/definitions/orNull`)
